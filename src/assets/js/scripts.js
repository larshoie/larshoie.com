...
//   });
  ...
  //   .appendTo('.col2')
    ...
    */
    ...
    $('.design-is-everything').find('h2').lettering('words');
    $('.design-is-everything h2 .word1').circleType({radius: 400, dir:1});
    $('.design-is-everything h2 .word2').circleType({radius: 500, dir:1});
    $('.design-is-everything h2 .word3').circleType({radius: 400, dir:-1});
...
//       var cHeight = $('.title').height()/8;
//       //var cWidth = $('.title').width();
//
//       // get box padding (assume all padding have same value)
//       var pad = parseInt($('.title').css('padding-top').replace('px', ''));
//
...
//       });
//     }
// $('.design-is-everything').find('h2').children().each(function() {
// moveRandom($(this));
// });
